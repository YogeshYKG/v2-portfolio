...
const ConfiguratorIcon = ({ size = 24, color = "currentColor", className = "" }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <g clipPath="url(#clip0_4418_3918)">
        <path
          d="M2 4.15002C2 2.72002 2.72002 2 4.15002 2H8.45001C9.88001 2 10.6 2.72002 10.6 4.15002V6"
          stroke={color}
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
        ...
        />
        <path
          d="M6.70001 17.9991H4.15002C2.72002 17.9991 2 17.2791 2 15.8491V8.03906"
          stroke={color}
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
