...
const BugIcon = ({ size = 24, color = "currentColor", className = "" }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <g clipPath="url(#clip0_4418_3351)">
        <path
        ...
        />
        <path
          d="M4.77 10.0098C4.59 10.6398 4.5 11.3098 4.5 11.9998C4.5 14.0098 5.29 15.8398 6.58 17.1898"
          stroke={color}
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
